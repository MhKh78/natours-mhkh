...
const createSendToken = (user, statusCode, res) => {
  ...
  if (process.env.NODE_ENV === 'production') cookieOptions.secure = true; // Means Https
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  // const message = `Forgot your password? Submit a PATH request with your password and password confirm to: ${resetURL}.\n
...
exports.updatePassword = catchAsync(async (req, res, next) => {
  ...
  user.passwordConfirm = req.body.passwordConfirm;
  await user.save();
  // User.findByIdAndUpdate will NOT work (no middleware and no validation)
